...
P.VLR_PRODUTO_COMPRA, P.NOME AS NOME_PRODUTO, IPC.QTD_ITEM_PEDIDO_COMPRA AS QTD
...
-- Exemplo Group By 2
SELECT P.COD_PRODUTO, TP.DES_TIPO_PRODUTO,
...
ORDER BY VALOR_GASTO_CLIENTE DESC
...
(
    ...
    [MEDIA_VLR_PEDIDO] FLOAT(15,2) NOT NULL, 
...
SELECT SUM(PV.VLR_PEDIDO_VENDA) AS TOTAL_VENDAS
FROM PEDIDO_VENDA PV
WHERE PV.DATA_PEDIDO BETWEEN '2023-01-01 00:00:00' AND '2023-31-12 00:00:00'

-- EXEMPLO DE SUB-QUERY
INSERT INTO RELATORIO (COD_RELATORIO, VLR_TOTAL, MEDIA_VLR_PEDIDO, DATA_INICIO, DATA_FIM)
VALUES(1, (SELECT SUM(PV.VLR_PEDIDO_VENDA) AS TOTAL_VENDAS
FROM PEDIDO_VENDA PV
WHERE PV.DATA_PEDIDO BETWEEN '2023-01-01 00:00:00' AND '2023-31-12 00:00:00'
), (SELECT AVG(VLR_PEDIDO_VENDA) AS MEDIA_VLR_PEDIDO FROM PEDIDO_VENDA PV), 
'2023-01-01 00:00:00', '2023-31-12 00:00:00')

select * from RELATORIO

-- EXEMPLO DE UNION
SELECT VLR_PEDIDO_VENDA AS VLR FROM PEDIDO_VENDA pv
UNION
SELECT VLR_PEDIDO_COMPRA AS VLR FROM PEDIDO_COMPRA pc

-- EXEMPLO DE AVG (AVERAGE) -- MÉDIA
SELECT AVG(VLR_PEDIDO_VENDA) AS MEDIA_VLR_PEDIDO FROM PEDIDO_VENDA PV

-- EXEMPLOS MAX
SELECT MAX(VLR_PEDIDO_VENDA) AS MEDIA_VLR_PEDIDO FROM PEDIDO_VENDA PV

-- EXEMPLOS MIN
SELECT MIN(VLR_PEDIDO_VENDA) AS MEDIA_VLR_PEDIDO FROM PEDIDO_VENDA PV
