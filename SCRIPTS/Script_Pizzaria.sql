...
VALUES (1, 'JENNIFER', '31994533390', 'R. LK 161');
...
SELECT * FROM CLIENTE WHERE NOME LIKE 'JEN%';
...
UPDATE CLIENTE SET NOME = 'JENNI' WHERE COD_CLIENTE = 1;
UPDATE VENDEDOR SET NOME = 'ANA PAULA' WHERE COD_VENDEDOR = 1;
UPDATE FORNECEDOR SET NOME = 'JOÃO' WHERE COD_VENDEDOR = 1;
UPDATE TIPO_PRODUTO SET DESCRICAO = 'MASSAS' WHERE COD_TIPO_PRODUTO = 1;
UPDATE COTACAO SET VLR_COTACAO = 200 WHERE COD_COTACAO = 1;
UPDATE FORMA_PAGAMENTO SET FORMA_PAGAMENTO = 'CRÉDITO A VISTA' WHERE COD_FORMA_PAGAMENTO = 1;
